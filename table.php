...
<body>
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                             ...
                             <li>
                                <a href="seller.php" aria-expanded="true"><i class="fa fa-table"></i>
                                    <span>sold Item Records</span></a>
  ...
  <h5 style="text-align:center">add Item Here</h5>
  <br>
  ...
  <br>
			...
			<?php 
               ...
               $sql1  = "SELECT quantity from product where product_name = 'lux' ";
               $sql2 = "SELECT s_quant from sold where s_name = 'lux' ";
 ...
 <html>
     <body>     
   <form method="POST" class="form-inline" action="seller.php">
   <div class="form-group">
    <label for="name">Product Name</label>
  ...
  <div class="form-group">
        <label for="name">Quantity</label>
        <input type="number" name="quanty" id="quanty" min="1" max="">
    </div>
   &nbsp;&nbsp;&nbsp;
  <button type="submit" class="btn btn-default" name="sell">sell item</button>
